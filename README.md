...
**Available now (0.1.9) — three live rules:** project-wide **unused public API**
...
> **0.1.9.** Three analysis rules are live — `unused-public-exports`,
...
**0.1.9** — three rules live end to end (`unused-public-exports`,
